...
void Object3D::translateRelX(float s) { translateRel(s, Vector3::X); }

void Object3D::translateRelY(float s) { translateRel(s, Vector3::Y); }

void Object3D::translateRelZ(float s) { translateRel(s, Vector3::Z); }
