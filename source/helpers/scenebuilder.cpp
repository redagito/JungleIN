...
Scene *SceneBuilder::build() {
  ...
  SkyBox *skyBox = new SkyBox(
      new MaterialSkyBox(new TextureCube("resources/cubemaps/miramar/")));
  ...
  Mesh *btree =
      ObjLoader::loadObj("resources/meshes/bamboopalm/bamboopalm.obj");
  ...
  Mesh *gpalm =
      ObjLoader::loadObj("resources/meshes/groundpalm/groundpalm.obj");
  ...
  Mesh* splant1 =
  ObjLoader::loadObj("resources/meshes/smallplant1/smallplant1.obj");
