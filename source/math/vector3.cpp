...
float Vector3::dot(const Vector3 &v) { return x * v.x + y * v.y + z * v.z; }

Vector3 &Vector3::normalize() { return divideScalar(length()); }
...
bool Vector3::isZero() { return (x == 0.0f && y == 0.0f && z == 0.0f); }
