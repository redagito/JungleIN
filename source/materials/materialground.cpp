...
MaterialGround::MaterialGround(Texture *moss, Texture *earth, Texture *shatter,
                               Texture *mossNormal, Texture *earthNormal,
...
void MaterialGround::setHeightRange(float f) { heightRange = f; }
