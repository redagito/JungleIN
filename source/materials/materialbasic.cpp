...
void MaterialBasic::setColor(const Vector3 &_color) { color.copy(_color); }

Vector3 &MaterialBasic::getColor() { return color; }
...
bool MaterialBasic::hasAlpha() { return hAlpha; }

Texture *MaterialBasic::getAlpha() { return alpha; }
